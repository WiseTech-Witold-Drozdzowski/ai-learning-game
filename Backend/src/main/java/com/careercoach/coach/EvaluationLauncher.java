...
public class EvaluationLauncher implements AiVerificationLauncher {
    ...
    @Override
    public Long launchEvaluation(Task task, String artifact, List<String> answers) {
        EvaluationInput input = new EvaluationInput(task.getId(), task.getTypeKey(), artifact, answers);
